 ...
 */
public class CompoundIdentityTest extends JakartaPersistenceTestCase
{
    ...
    {
        EntityManagerFactory emf = getEMF(1, "JakartaTest", null); // Swap to "JPATest" EMF
        try
        {
    ...
    {
        EntityManagerFactory emf = getEMF(1, "JakartaTest", null); // Swap to "JakartaTest" EMF
        try
        {
