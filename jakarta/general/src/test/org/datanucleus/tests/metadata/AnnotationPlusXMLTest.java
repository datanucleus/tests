...
public class AnnotationPlusXMLTest extends JakartaPersistenceTestCase
{
    ...
    {
        NucleusContext nucleusCtx = new NucleusContext("Jakarta", null);
        ClassLoaderResolver clr = new ClassLoaderResolverImpl();
        MetaDataManager metaDataMgr = new JakartaMetaDataManager(pmfcontext);
        PersistenceUnitMetaData pumd = metaDataMgr.getMetaDataForPersistenceUnit("JakartaTest");
