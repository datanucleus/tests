 ...
 */
public class EntityGraphTest extends JakartaPersistenceTestCase
{
    ...
    public void testNamedGraphSpecification()
    {
        try
        {
            Set<String> graphNames = ((JakartaEntityManagerFactory)emf).getEntityGraphNames();
            assertNotNull(graphNames);
            assertEquals("Number of EntityGraphs is wrong", 1, graphNames.size());
            JakartaEntityGraph eg = (JakartaEntityGraph)((JakartaEntityManagerFactory)emf).getNamedEntityGraph(graphNames.iterator().next());
    ...
    public void testQueryDefinedEntityGraph_FetchGraph()
    {
        try
        {
            ...
            try
            {
                ...
                LOG.info(">> FetchPlan=" + ((JakartaQuery)q).getFetchPlan());
                Set<String> fpgroups = ((JakartaQuery)q).getFetchPlan().getGroups();
    ...
    public void testQueryNamedEntityGraph_FetchGraph()
    {
        try
        {
            ...
            try
            {
                ...
                LOG.info(">> Query : FetchPlan=" + ((JakartaQuery)q).getFetchPlan());
                Set<String> fpgroups = ((JakartaQuery)q).getFetchPlan().getGroups();
                assertEquals(1, fpgroups.size());
