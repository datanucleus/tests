...
/**
 * Tests for use of JTA with Jakarta Persistence, using container-managed EMF.
 */
public class ContainerManagedTest extends JakartaPersistenceTestCase
{
    ...
    public ContainerManagedTest(String name)
    {
        ...
        if (jtaEMF == null)
        {
            ...
            try
            {
                rootURL = new URL("file:/home/andy/work/datanucleus/tests/jakarta/jta/target/classes");
            }
            ...
            jtaEMF = new JakartaEntityManagerFactory(unitInfo, overridingProps);
        }
    }
