...
/**
 * Series of tests for using JTA with Jakarta Persistence using application-managed EMF.
 ...
 */
public class ApplicationManagedTest extends JakartaPersistenceTestCase
{
