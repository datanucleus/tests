...
CREATE TABLE DATATYPES2 ( DATATYPES2_ID DATE NOT NULL, TIMEDATA TIME, TSDATA TIMESTAMP, BYTEDATA BLOB(2G), CHARDATA VARCHAR(448), CONSTRAINT PK_DATATYPES2 PRIMARY KEY (DATATYPES2_ID));
