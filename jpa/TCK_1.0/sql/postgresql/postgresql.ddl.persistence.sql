...
CREATE TABLE EMPLOYEE (ID INTEGER PRIMARY KEY NOT NULL, FIRSTNAME VARCHAR(255) , LASTNAME VARCHAR(255), HIREDATE DATE, SALARY NUMERIC(126) NOT NULL,  STATUS VARCHAR(255) , FK_MGR INTEGER, FK_DEPT INTEGER, FK_PROJECT INTEGER , FK_INS INTEGER) ;
...
CREATE TABLE DATATYPES ( BOOLEANDATA BOOLEAN, CHARDATA CHAR, SHORTDATA SMALLINT, INTDATA INTEGER, LONGDATA BIGINT, DBLDATA DOUBLE PRECISION, FLOATDATA FLOAT, ID SERIAL PRIMARY KEY NOT NULL, ENUMODATA INTEGER, ENUMSDATA VARCHAR(25), BYTEDATA SMALLINT);

DROP TABLE DATATYPES2 cascade;
CREATE TABLE DATATYPES2 ( DATATYPES2_ID DATE , TIMEDATA TIME, TSDATA TIMESTAMP, BYTEDATA BYTEA NULL, CHARDATA VARCHAR(448), CONSTRAINT DT2_PK PRIMARY KEY(DATATYPES2_ID) );
...
CREATE TABLE ORDER1 (ID VARCHAR(255) NOT NULL PRIMARY KEY, TOTALPRICE DOUBLE PRECISION , FK1_FOR_ITEM VARCHAR(255));
 
DROP TABLE ORDER2 cascade;
CREATE TABLE ORDER2 (ID VARCHAR(255) NOT NULL PRIMARY KEY, TOTALPRICE DOUBLE PRECISION , FK2_FOR_ITEM VARCHAR(255));

DROP TABLE ORDER3 cascade;
CREATE TABLE ORDER3 (ID VARCHAR(255) NOT NULL PRIMARY KEY, TOTALPRICE DOUBLE PRECISION , FK3_FOR_ITEM VARCHAR(255));
