...
public abstract class SignatureTestDriver {
     ...
     * and SigTestEE class.
     */
    public String getPackageFileImpl(String tsHome) {
        ...
        TestUtil.logMsg("Using the following as the sigTest pkg-list file: " + thePkgListFile);

        String theFile = tsHome + File.separator + "bin" + File.separator + thePkgListFile;
     ...
     * SigTestEE class.
     */
    public String getMapFileImpl(String tsHome) {
        ...
        String theFile = tsHome + File.separator + "bin" + File.separator + theMapFile;
        File ff = new File(theFile);
        if (!ff.exists()) {
