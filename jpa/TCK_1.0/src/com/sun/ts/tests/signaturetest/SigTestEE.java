...
public abstract class SigTestEE extends ServiceEETest {
    ...
    protected String getPackageFile() {
        return getSigTestDriver().getPackageFileImpl(testInfo.getTSHome());
    }
    ...
    protected String getMapFile() {
        return getSigTestDriver().getMapFileImpl(testInfo.getTSHome());
    }
    ...
    protected SigTestData testInfo; // holds the tsHome and vehicle properties
