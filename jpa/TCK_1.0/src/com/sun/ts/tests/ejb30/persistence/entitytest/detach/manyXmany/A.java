...
public class A implements java.io.Serializable {
    ...
    @ManyToMany(targetEntity=com.sun.ts.tests.ejb30.persistence.entitytest.detach.manyXmany.B.class, cascade={CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE, CascadeType.REFRESH})
