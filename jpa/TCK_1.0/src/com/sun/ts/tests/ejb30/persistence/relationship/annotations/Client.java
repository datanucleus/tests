...
public class Client extends PMClientBase {
  ...
  public void setup(String[] args, Properties p) throws Fault
     ...
     *                 PESISTENCE:JAVADOC:91; PERSISTENCE:SPEC:561;
     ...
     * @test_Strategy: RelationShip Mapping Annotations
    ...
    public void annotationMappingTest1() throws Fault
    {

      TLogger.log("Begin annotationMappingTest1");
      boolean pass = false;
	...
	if (newPerson.getProject().getName().equals("Asp") ) {
                TLogger.log("annotationMappingTest1: Expected results received");
		pass = true;
	}
     ...
     *                 PERSISTENCE:JAVADOC:9; PERSISTENCE:JAVADOC:110;
     *                 PERSISTENCE:SPEC:561; PERSISTENCE:SPEC:564;
     *		       PERSISTENCE:SPEC:567; PERSISTENCE:SPEC:570;
    ...
    public void annotationMappingTest2() throws Fault
    {

      TLogger.log("Begin annotationMappingTest2");
      boolean pass1 = true;
      boolean pass2 = false;
      Vector<Team> v1 = null;
      Vector<Team> v2 = null;
	...
	if( (t1.size() != 3) || (t2.size() != 2) ) {
                TLogger.log("ERROR:  annotationMappingTest2: Did not get expected results." 
           ...
           if ((foundTeam1 != 3) || (foundTeam2 != 2)) {
                  ...
                  TLogger.log(
                    "annotationMappingTest2: Expected results received");
		  pass2 = true;
           }
     ...
     *                 PERSISTENCE:SPEC:561; PERSISTENCE:SPEC:563;
     *		       PERSISTENCE:SPEC:567; PERSISTENCE:SPEC:570;
     *                 PERSISTENCE:SPEC:571
     * @test_Strategy: RelationShip Mapping Annotations
    ...
    public void annotationMappingTest3() throws Fault
    {

      TLogger.log("Begin annotationMappingTest3");
      boolean pass = false;
      Vector v1 = null;
      Vector v2 = null;
    ...
    public void annotationMappingTest4() throws Fault
    {

    TLogger.log("Begin annotationMappingTest4");
    boolean pass = false;
	...
	try {
	  ...
	  if (c1.getAddress().getCity().equals("Burlington") &&
		...
		pass = true;
    		...
    		TLogger.log("annotationMappingTest4: Did not get expected results" +
    ...
    public void annotationMappingTest5() throws Fault
    {
      TLogger.log("Begin annotationMappingTest5");
      boolean pass = false;
	...
	for (int i=1; i<11; i++) {
        ...
        getEntityManager().flush();
            ...
            if ( ( pRef[1].getTeam() == tRef[0] )   && ( pRef[10].getTeam() == tRef[0] )   &&
             ...
             TLogger.log(
                    "annotationMappingTest5: Expected results received");
              pass = true;
           } else {
                  TLogger.log(
                    "annotationMappingTest5: Did not get expected results ");
                  pass = false;
           }
     ...
     *                 PERSISTENCE:JAVADOC:1099; PERSISTENCE:JAVADOC:106;
     *                 PERSISTENCE:JAVADOC:99; PERSISTENCE:JAVADOC:100;
     *                 PERSISTENCE:JAVADOC:101; PERSISTENCE:SPEC:561;
     *                 PERSISTENCE:SPEC:565; PERSISTENCE:SPEC:567;
     *                 PERSISTENCE:SPEC:574; PERSISTENCE:SPEC:1099
     * @test_Strategy: RelationShip Mapping Annotations
    ...
    public void annotationMappingTest6() throws Fault
    {
      TLogger.log("Begin annotationMappingTest6");
      boolean pass1 = true;
      boolean pass2 = false;
      Vector<Team> v1 = null;
      Vector<Team> v2 = null;
	...
	Collection<Project> projCol2 = p2.getProjects();
        ...
        if( (projCol1.size() != 3) || (projCol2.size() != 3 ) ) {
                TLogger.log("ERROR:  annotationMappingTest6: Did not get expected results."
          ...
          if ( (foundProject1 != 3) || (foundProject2 != 3) ) {
                ...
                pass2 = false;
                  ...
                  TLogger.log(
                    "annotationMappingTest6: Expected results received");
                  pass2 = true;
           }
     ...
     *                 PERSISTENCE:JAVADOC:99; PERSISTENCE:JAVADOC:100;
     *                 PERSISTENCE:JAVADOC:101; PERSISTENCE:SPEC:561;
     *                 PERSISTENCE:SPEC:563; PERSISTENCE:SPEC:568
     * @test_Strategy: RelationShip Mapping Annotations
    ...
    public void annotationMappingTest7() throws Fault
    {
    TLogger.log("Begin annotationMappingTest7");
      boolean pass1 = true;
      boolean pass2 = false;
	...
	Collection<AnnualReview> col5 = p5.getAnnualReviews();
		...
		col3.size() != 2 || col4.size() != 2 || col5.size() != 4 ) ) {
                TLogger.log("ERROR:  annotationMappingTest7: Did not get expected results."
 		...
 		(foundCol3 != 2) || (foundCol4 != 2) || (foundCol5 != 4 ) ) {
                ...
                pass2 = false;
                  ...
                  TLogger.log(
                    "annotationMappingTest7: Expected results received");
                  pass2 = true;
           }
     ...
     * @assertion_ids: PERSISTENCE:SPEC:1097; PERSISTENCE:SPEC:1098;
     *                 PERSISTENCE:JAVADOC:1099; PERSISTENCE:JAVADOC:99;
     *                 PERSISTENCE:JAVADOC:100; PERSISTENCE:JAVADOC:101;
     *                 PERSISTENCE:SPEC:561; PERSISTENCE:SPEC:565;
    ...
    public void annotationMappingTest8() throws Fault
    {
      boolean pass1 = true;
      boolean pass2 = false;
	...
	Collection<Insurance> insCol3 = p3.getInsurance();
        ...
        if( (insCol1.size() != 2) || (insCol2.size() != 2 ) || (insCol3.size() != 3) ) {
                TLogger.log("ERROR:  annotationMappingTest8: Did not get expected results."
        ...
        if ( (foundInsurance1 != 2) || (foundInsurance2 != 2) || (foundInsurance3 != 3) ) {
               ...
               TLogger.log(
                    "annotationMappingTest8: Expected results received");
               pass2 = true;
        }
