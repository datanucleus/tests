...
public class A implements java.io.Serializable {
    ...
    @OneToMany(targetEntity=com.sun.ts.tests.ejb30.persistence.entitytest.detach.oneXmany.B.class, cascade={CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE, CascadeType.REFRESH}, mappedBy="a1")
