...
public class Client extends PMClientBase implements java.io.Serializable  {
     ...
     *                 PERSISTENCE:JAVADOC:25; PERSISTENCE:JAVADOC:26;
     *                 PERSISTENCE:JAVADOC:28; PERSISTENCE:SPEC:1112;
     *                 PERSISTENCE:SPEC:1113; PERSISTENCE:SPEC:1116;
     *                 PERSISTENCE:SPEC:1118; PERSISTENCE:SPEC:587;
     *                 PERSISTENCE:JAVADOC:509; PERSISTENCE:JAVADOC:23;
     *                 PERSISTENCE:JAVADOC:86; PERSISTENCE:JAVADOC:87
    ...
    public void abstractEntityTest1() throws Fault
    {
      ...
      TLogger.log("Begin abstractEntityTest1");
      boolean pass = false;
    ...
    public void abstractEntityTest2() throws Fault
    {
      ...
      TLogger.log("Begin abstractEntityTest2");
      boolean pass = false;
