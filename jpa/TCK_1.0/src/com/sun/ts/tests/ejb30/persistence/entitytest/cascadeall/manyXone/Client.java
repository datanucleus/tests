...
/*
 * @(#)Client.java	1.10 06/06/26
 */

package com.sun.ts.tests.ejb30.persistence.entitytest.cascadeall.manyXone;
...
public class Client extends PMClientBase {
  ...
  public void setup(String[] args, Properties p) throws Fault
     ...
     */
     ...
     {
     TLogger.log("Begin cascadeAllMX1Test1");
     boolean pass = false;
     A aRef = null;
    ...
    {
     TLogger.log("Begin cascadeAllMX1Test2");
     boolean pass = false;
     A aRef = null;
     A newA = null;
   ...
   {
     TLogger.log("Begin cascadeAllMX1Test3");
     boolean pass = false;
     A aRef = null;
   ...
   /*
     ...
     */
     ...
     {
     TLogger.log("Begin cascadeAllMX1Test4");
     boolean pass = false;
     A aRef = null;
