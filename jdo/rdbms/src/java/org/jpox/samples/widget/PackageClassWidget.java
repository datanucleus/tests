...
/**
 * This class is used to test the placement of MetaData files. It uses the PackageClassWidget.jdo file at this level.
 *
 * @version $Revision: 1.1 $ 
 **/
public class PackageClassWidget implements Serializable
{
    private static final long serialVersionUID = -4428763646602452274L;
    ...
    public String toString()
    {
        ...
        s.append("  normalString = ").append(normalString).append("\n");
