 ...
 * {@link org.datanucleus.samples.jfire.organisation.JFireOrganisation}.
 * <p>This class was auto-generated using XDoclet.
 */
public class JFireOrganisationID implements Serializable
{
	private static final long serialVersionUID = 8317285581004355173L;
	/**
	 ...
	 *
	 * See {@link org.datanucleus.samples.jfire.organisation.JFireOrganisation#organisationID}.
	 */
	public java.lang.String organisationID;

	/**
	 * Create a new empty instance of OrganisationID.
	 */
	public JFireOrganisationID()
	{
	}

	/**
	 * Create a new instance of OrganisationID.
	 ...
	 * <code>OrganisationID newOrganisationID = new OrganisationID(oldOrganisationID.toString());</code>
	 *
	 ...
	 */
	public JFireOrganisationID(String keyStr)
        ...
        while (st.hasMoreTokens())
        {
            ...
            if (valStr == null)
            {
                ...
                else
                {
                    ...
                    if (byte.class.isAssignableFrom(fieldType) || short.class.isAssignableFrom(fieldType) || int.class
                            .isAssignableFrom(fieldType) || long.class.isAssignableFrom(fieldType) || float.class
                            .isAssignableFrom(fieldType) || double.class.isAssignableFrom(fieldType))
     ...
     * <p>
     * JDO expects the result of this method to be compatible with the constructor {@link #OrganisationID(String)}. This
     * method takes all the primary-key-fields and encodes them with their name and their value.
    ...
    public boolean equals(Object obj)
    {
        ...
        if (!(obj instanceof JFireOrganisationID))
            return false;

        JFireOrganisationID other = (JFireOrganisationID) obj;

        return ((this.organisationID == other.organisationID) || (this.organisationID != null && this.organisationID
    ...
    /**
     * Returns a hash code for this object id. The hash code for a object id object is computed by generating hash codes
     * for all primary key fields and XOR'ing them.
     * @return a hash code value for this object.
     */
    public int hashCode()
    {
        return (organisationID == null ? 0 : organisationID.hashCode()) // Normally, it should never be null, but still
                                                                        // it just happened to me! Marco.
        ;
    }

    /**
     * Create a new object id instance.
     * @param organisationID The primary key field organisationID. See
     * {@link org.datanucleus.samples.jfire.organisation.JFireOrganisation#organisationID}.
     * @return a newly created instance of <code>OrganisationID</code> with the primary-key fields set to the given
     * parameters.
     */
    public static JFireOrganisationID create(java.lang.String organisationID)
    {
        JFireOrganisationID n = new JFireOrganisationID();
