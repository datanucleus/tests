 ...
 */
public class UserId1 implements java.io.Serializable
{
	private static final long serialVersionUID = 3982022358193710039L;
    public String id;
	...
	public boolean equals (Object ob)
	{
		if (this == ob)
			return true;
		if (!(ob instanceof UserId1))
			return false;

		UserId1 other = (UserId1) ob;
