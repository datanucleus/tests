...
public class JDOQLSingleStringParserTest extends JDOPersistenceTestCase
{
    ...
    public void testImport()
    {
        ...
        String str = "SELECT FROM org.datanucleus.samples.MyClass import java.util.*; import java.net.*";
        ...
        String expectationString = "SELECT FROM org.datanucleus.samples.MyClass import java.util.*;import java.net.*";
    ...
    public void testVariableBeforeParameter()
    {
        ...
        Query q = pm.newQuery("JDOQL", null);
        AbstractJDOQLQuery query = (AbstractJDOQLQuery) ((JDOQuery)q).getInternalQuery();
        String str = "SELECT FROM org.datanucleus.samples.MyClass PARAMETERS String p1 VARIABLES int v1";
        JDOQLSingleStringParser parser = new JDOQLSingleStringParser(query, str);
        try
        {
            parser.parse();
    ...
    public void testWhereWithMultipleSpaces()
    {
        ...
        Query q = pm.newQuery("JDOQL", null);
        AbstractJDOQLQuery query = (AbstractJDOQLQuery) ((JDOQuery)q).getInternalQuery();
        String str = "SELECT FROM org.datanucleus.samples.MyClass WHERE field1 == 'The     value to compare against'";
        JDOQLSingleStringParser parser = new JDOQLSingleStringParser(query, str);
        try
        {
            parser.parse();
    ...
    public void testLiteralWithKeyword()
    {
        ...
        Query q = pm.newQuery("JDOQL", null);
        AbstractJDOQLQuery query = (AbstractJDOQLQuery) ((JDOQuery)q).getInternalQuery();
        String str = "SELECT FROM org.datanucleus.samples.MyClass WHERE field1 == 'The book from which I took inspiration'";
        JDOQLSingleStringParser parser = new JDOQLSingleStringParser(query, str);
        try
        {
            parser.parse();
    ...
    public void testSubselectWithMissingCloseParen()
    {
        ...
        Query q = pm.newQuery("JDOQL", null);
        AbstractJDOQLQuery query = (AbstractJDOQLQuery) ((JDOQuery)q).getInternalQuery();
        String str = "SELECT FROM org.datanucleus.samples.MyClass WHERE field1 > (SELECT avg(f.field1) FROM org.datanucleus.samples.MyClass f";
        JDOQLSingleStringParser parser = new JDOQLSingleStringParser(query, str);
        try
        {
            parser.parse();
    ...
    public void testSubquery()
    {
        ...
        Query q = pm.newQuery("JDOQL", null);
        AbstractJDOQLQuery query = (AbstractJDOQLQuery) ((JDOQuery)q).getInternalQuery();
        String str = "SELECT FROM org.datanucleus.samples.MyClass WHERE field1 > " + 
            "(SELECT avg(f.field1) FROM org.datanucleus.samples.MyClass f)";
        JDOQLSingleStringParser parser = new JDOQLSingleStringParser(query, str);
        try
        {
            parser.parse();
            ...
            assertEquals(subq1.getQuery().toString(), "SELECT avg(f.field1) FROM org.datanucleus.samples.MyClass f");
    ...
    public void testSubquery2()
    {
        ...
        Query q = pm.newQuery("JDOQL", null);
        AbstractJDOQLQuery query = (AbstractJDOQLQuery) ((JDOQuery)q).getInternalQuery();
        String str = "SELECT FROM org.datanucleus.samples.MyClass WHERE " +
            "field1 > (SELECT avg(f.field1) FROM org.datanucleus.samples.MyClass f) AND " +
            "field2 > (SELECT min(s.field1) FROM org.datanucleus.samples.OtherClass s)";
        JDOQLSingleStringParser parser = new JDOQLSingleStringParser(query, str);
        try
        {
            parser.parse();
            SubqueryDefinition subq1 = query.getSubqueryForVariable("DN_SUBQUERY_1");
            assertNotNull("Subquery #1 should be generated by single-string parser but isnt", subq1);
            assertEquals("SELECT avg(f.field1) FROM org.datanucleus.samples.MyClass f", subq1.getQuery().toString());

            SubqueryDefinition subq2 = query.getSubqueryForVariable("DN_SUBQUERY_2");
            assertNotNull("Subquery #2 should be generated by single-string parser but isnt", subq2);
            assertEquals("SELECT min(s.field1) FROM org.datanucleus.samples.OtherClass s", subq2.getQuery().toString());
        }
        catch (NucleusUserException e)
        {
            fail("Exception in parser : "+e.getMessage());
