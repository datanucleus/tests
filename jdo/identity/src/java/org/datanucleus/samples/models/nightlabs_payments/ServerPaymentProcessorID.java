...
Contributions
    ...
***********************************************************************/
package org.datanucleus.samples.models.nightlabs_payments;
...
public class ServerPaymentProcessorID implements Serializable
{
	...
	public java.lang.String serverPaymentProcessorID;

	public ServerPaymentProcessorID() { }

	public ServerPaymentProcessorID(String keyStr) throws ParseException, SecurityException, NoSuchFieldException,
            IllegalArgumentException, IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException
    {
    ...
    public String toString()
    {
        ...
        try
        {
            ...
            sb.append('&');
            sb.append("serverPaymentProcessorID=");
            sb.append(URLEncoder.encode(String.valueOf(serverPaymentProcessorID), ENCODING));
        }
        catch (UnsupportedEncodingException e)
        {
    ...
    public boolean equals(Object obj)
    {
        ...
        if (!(obj instanceof ServerPaymentProcessorID))
            return false;

        ServerPaymentProcessorID other = (ServerPaymentProcessorID) obj;

        return ((this.organisationID == other.organisationID) || (this.organisationID != null && this.organisationID
                .equals(other.organisationID))) && ((this.serverPaymentProcessorID == other.serverPaymentProcessorID) || (this.serverPaymentProcessorID != null && this.serverPaymentProcessorID
                .equals(other.serverPaymentProcessorID)));
    }
    ...
    public int hashCode()
    {
        return (organisationID == null ? 0 : organisationID.hashCode()) ^ 
            (serverPaymentProcessorID == null ? 0 : serverPaymentProcessorID.hashCode());
    }

    public static ServerPaymentProcessorID create(String organisationID, 
