...
/**
 * Class with identity using single field of type String.
 * @version $Revision: 1.1 $
 */
public class SimpleStringIDBase extends TestObject implements InstanceCallbacks 
{
	...
	public boolean compareTo(Object obj)
	{
		if (this == obj)
			return true;
		if (!(obj instanceof SimpleStringIDBase))
			return false;

		SimpleStringIDBase other = (SimpleStringIDBase) obj;
		return
