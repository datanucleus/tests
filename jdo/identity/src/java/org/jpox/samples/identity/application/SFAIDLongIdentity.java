 ...
 */
public class SFAIDLongIdentity extends TestObject implements InstanceCallbacks
{
    private long code;

    private String description;

    public SFAIDLongIdentity()
    {
        super();
    }
    ...
    public boolean compareTo(Object obj)
    {
        if (this == obj)
            return true;
        if (!(obj instanceof SFAIDLongIdentity))
            return false;

        SFAIDLongIdentity other = (SFAIDLongIdentity) obj;
