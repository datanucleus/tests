 ...
 */
public class SFAIDShortObjIdentity extends TestObject implements InstanceCallbacks
{
    private Short code;

    private String description;

    public SFAIDShortObjIdentity()
    {
        super();
    }
    ...
    public boolean compareTo(Object obj)
    {
        if (this == obj)
            return true;
        if (!(obj instanceof SFAIDShortObjIdentity))
            return false;

        SFAIDShortObjIdentity other = (SFAIDShortObjIdentity) obj;
