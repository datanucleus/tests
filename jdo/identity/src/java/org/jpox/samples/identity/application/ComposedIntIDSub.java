 ...
 */
public class ComposedIntIDSub extends ComposedIntIDBase
{
    ...
    public boolean compareTo(Object obj)
    {
        if (this == obj)
            return true;
        if (!(obj instanceof ComposedIntIDSub) || !super.compareTo(obj))
            return false;

        ComposedIntIDSub other = (ComposedIntIDSub) obj;
