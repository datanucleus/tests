 ...
 */
public class SimpleStringIDSub extends SimpleStringIDBase
{
    ...
    public boolean compareTo(Object obj)
    {
        if (this == obj)
            return true;
        if (!(obj instanceof SimpleStringIDSub) || !super.compareTo(obj))
            return false;

        SimpleStringIDSub other = (SimpleStringIDSub) obj;
