 ...
 */
public class ComposedStringIDSub extends ComposedStringIDBase
{
    ...
    public boolean compareTo(Object obj)
    {
        if (this == obj)
            return true;
        if (!(obj instanceof ComposedStringIDSub) || !super.compareTo(obj))
            return false;

        ComposedStringIDSub other = (ComposedStringIDSub) obj;
