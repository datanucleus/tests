...
public class AbstractClassesTest extends JDOPersistenceTestCase
{
    ...
    public AbstractClassesTest(String name)
    {
        ...
        if (!initialised)
        {
            ...
            addClassesToSchema(new Class[]
                {
                    AbstractCompositeBase.class,
                    ConcreteCompositeSub1.class,
                    ConcreteCompositeSub2.class,
                    AbstractCompositeClassHolder.class
                }
            );
            initialised = true;
        }
    ...
    /**
     * Convenience method to create 2 holders with ConcreteCompositeSub1, ConcreteCompositeSub2 related objects.
     */
    private void perform1to1CreationComposite()
    throws Exception
    {
        ...
        try
        {
            ...
            tx.begin();
            AbstractCompositeClassHolder holder1 = new AbstractCompositeClassHolder(1);
            ConcreteCompositeSub1 sub1 = new ConcreteCompositeSub1(1, "First");
            sub1.setBaseField("Base1");
            sub1.setSub1Field("Sub1");
            holder1.setAbstract1(sub1);
            pm.makePersistent(holder1);

            AbstractCompositeClassHolder holder2 = new AbstractCompositeClassHolder(2);
            ConcreteCompositeSub2 sub2 = new ConcreteCompositeSub2(2, "Second");
            ...
            tx.commit();
            assertTrue("Id of Abstract object ConcreteCompositeSub1 was null!", pm.getObjectId(sub1) != null);
            assertTrue("Id of Abstract object ConcreteCompositeSub2 was null!", pm.getObjectId(sub1) != null);
     ...
     */
    private void perform1toNJoinTableSetCreationComposite()
    throws Exception
    {
        PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx = pm.currentTransaction();
        try
        {
            ...
            tx.begin();
            AbstractCompositeClassHolder holder = new AbstractCompositeClassHolder(1);
     ...
     */
    private void perform1toNJoinTableListCreationComposite()
    throws Exception
    {
        PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx = pm.currentTransaction();
