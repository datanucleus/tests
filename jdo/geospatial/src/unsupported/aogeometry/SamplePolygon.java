...
public class SamplePolygon extends SampleGeometry
{
    private Polygon geom;
    
    public SamplePolygon(long id, String name, Polygon polygon)
    {
        this.id = id;
        this.name = name;
        this.geom = polygon;
    ...
    {
        if (!(obj instanceof SamplePolygon))
            return false;

        SamplePolygon other = (SamplePolygon) obj;
