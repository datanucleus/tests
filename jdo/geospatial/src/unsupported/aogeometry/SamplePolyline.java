...
public class SamplePolyline extends SampleGeometry
{
    private Polyline geom;

    public SamplePolyline(long id, String name, Polyline polyline)
    {
        this.id = id;
        this.name = name;
        this.geom = polyline;
    ...
    {
        if (!(obj instanceof SamplePolyline))
            return false;

        SamplePolyline other = (SamplePolyline) obj;
