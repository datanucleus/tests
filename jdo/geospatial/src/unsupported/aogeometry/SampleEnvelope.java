...
public class SampleEnvelope extends SampleGeometry
{
    private Envelope geom;
    
    public SampleEnvelope(long id, String name, Envelope envelope)
    {
        this.id = id;
        this.name = name;
        this.geom = envelope;
    ...
    {
        if (!(obj instanceof SampleEnvelope))
            return false;

        SampleEnvelope other = (SampleEnvelope) obj;
