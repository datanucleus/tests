...
public class SampleGeometryCollection
{
    ...
    public SampleGeometryCollection(long id, String name, GeometryCollection collection)
    {
        this.id = id;
        this.name = name;
    ...
    {
        if (!(obj instanceof SampleGeometryCollection))
            return false;

        SampleGeometryCollection other = (SampleGeometryCollection) obj;
        if (!(id == other.id))
            return false;
