...
public class SampleGeometryCollectionM
{
    ...
    public SampleGeometryCollectionM(long id, String name, GeometryCollection collection)
    {
        this.id = id;
        this.name = name;
    ...
    {
        if (!(obj instanceof SampleGeometryCollectionM))
            return false;

        SampleGeometryCollectionM other = (SampleGeometryCollectionM) obj;
        if (!(id == other.id))
            return false;
