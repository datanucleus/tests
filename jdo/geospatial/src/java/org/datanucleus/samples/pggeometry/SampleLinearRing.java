...
public class SampleLinearRing
{
    ...
    private LinearRing geom;

    public SampleLinearRing(long id, String name, LinearRing lineString)
    {
        this.id = id;
        this.name = name;
    ...
    {
        if (!(obj instanceof SampleLinearRing))
            return false;

        SampleLinearRing other = (SampleLinearRing) obj;
        if (!(id == other.id))
            return false;
