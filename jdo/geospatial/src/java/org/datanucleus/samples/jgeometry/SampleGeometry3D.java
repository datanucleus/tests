...
public class SampleGeometry3D
{
    ...
    public SampleGeometry3D(long id, String name, JGeometry geom)
    {
        this.id = id;
        this.name = name;
        this.geom = geom;
    ...
    {
        if (!(obj instanceof SampleGeometry3D))
            return false;

        SampleGeometry3D other = (SampleGeometry3D) obj;
        if (!(id == other.id))
            return false;
