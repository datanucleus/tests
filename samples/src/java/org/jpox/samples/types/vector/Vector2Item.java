...
Contributions
    ...
***********************************************************************/
package org.jpox.samples.types.vector;
...
/**
 * An item to store in an FK Vector container.
 *
...
public class Vector2Item
{
    ...
    protected Vector2 container;

    protected Vector2Item()
    {
    ...
    public Vector2Item(String name, double value, int status)
    {
        this.name   = name;
        this.value  = value;
        this.status = status;
    ...
    public Vector2 getContainer()
    {
        return container;
    }

    public void setContainer(Vector2 container)
    {
    ...
    {
        private static final long serialVersionUID = 2015443994198094156L;
