...
/**
 * An item to store in an Inverse Hashtable container.
 *
 * @version $Revision: 1.1 $  
 **/
public class Hashtable2Item
{
    ...
    protected Hashtable2 container;
    protected String key;

    protected Hashtable2Item()
    {
    ...
    public Hashtable2Item(String name, double value, int status)
    {
        this.name   = name;
        this.value  = value;
        this.status = status;
    ...
    {
        if( arg0 == null || !(arg0 instanceof Hashtable2Item) )
        {
            return false;
        }
        Hashtable2Item item = (Hashtable2Item)arg0;
    ...
    public Hashtable2 getContainer()
    {
        return container;
    }

    public void setContainer(Hashtable2 container)
    {
