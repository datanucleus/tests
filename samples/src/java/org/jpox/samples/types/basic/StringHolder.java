...
/**
 * Holder of String field types to use as a test for persisting basic information.
 * 
 * @version $Revision: 1.1 $
 */
public class StringHolder extends TestObject
{
    ...
    public boolean compareTo(Object obj)
    {
        ...
        StringHolder w = (StringHolder) obj;
        if (fixedLengthString == null)
        {
            if (w.fixedLengthString != null)
            {
                return false;
            }
        }
        else if (!fixedLengthString.equals(w.fixedLengthString))
        {
            return false;
        }
        ...
        {
            if (w.normalString != null)
                return false;
        }
        else if (!normalString.equals(w.normalString))
        {
            return false;
        }
