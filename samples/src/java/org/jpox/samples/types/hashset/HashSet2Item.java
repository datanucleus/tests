...
/**
 * An item to store in an FK HashSet container.
 *
 * @version $Revision: 1.1 $  
 **/
public class HashSet2Item implements Comparable
{
    ...
    protected HashSet2 container;

    protected HashSet2Item()
    {
    ...
    public HashSet2Item(String name,
                              double value,
                              int status)
    {
        this.name   = name;
    ...
    public void setContainer(HashSet2 cont)
    {
        container = cont;
    }
    ...
    {
        return compareTo((HashSet2Item)o);
    }

    public int compareTo(HashSet2Item other)
    {
    ...
    {
        if (obj == null || !(obj instanceof HashSet2Item))
        {
            return false;
        }

        HashSet2Item item = (HashSet2Item)obj;
    ...
    {
        private static final long serialVersionUID = -7178967921304424848L;
