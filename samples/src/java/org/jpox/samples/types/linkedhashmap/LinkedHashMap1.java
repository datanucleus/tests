 ...
 **/
public class LinkedHashMap1 implements MapHolder<String, ContainerItem>
{
    ...
    java.util.LinkedHashMap<String, ContainerItem> items=new java.util.LinkedHashMap<>();
    ...
    {
        private static final long serialVersionUID = 4778498198228473796L;
