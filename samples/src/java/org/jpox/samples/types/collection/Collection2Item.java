...
/**
 * An item to store in an FK Collection container.
 *
 * @version $Revision: 1.1 $  
 **/
public class Collection2Item implements Comparable
{
    ...
    protected Collection2 container;

    protected Collection2Item()
    {
    ...
    public Collection2Item(String name, double value, int status)
    {
        this.name   = name;
        this.value  = value;
        this.status = status;
    ...
    public void setContainer(Collection2 cont)
    {
        container = cont;
    }
    ...
    public Collection2 getContainer()
    {
        return container;
    }
    ...
    {
        return compareTo((Collection2Item)o);
    }

    public int compareTo(Collection2Item other)
    {
    ...
    {
        if (obj == null || !(obj instanceof Collection2Item))
        {
            return false;
        }

        Collection2Item item = (Collection2Item)obj;
