 ...
 */
public class Set2 implements CollectionHolder<Set2Item>
{
    ...
    java.util.Set<Set2Item> items = new java.util.HashSet<>();
    ...
    public java.util.Collection<Set2Item> getItems()
    {
        return items;
    }
    ...
    public void addItem(Set2Item item)
    {
        items.add(item);
    }

    public void addItems(java.util.Collection<Set2Item> c)
    {
        items.addAll(c);
    }

    public void removeItem(Set2Item item)
    {
        items.remove(item);
    }

    public void removeItems(java.util.Collection<Set2Item> c)
    {
        items.removeAll(c);
    }

    public void retainItems(java.util.Collection<Set2Item> c)
    {
        items.retainAll(c);
    }
    ...
    public void setItems(java.util.Set<Set2Item> items)
    {
        this.items = items;
    }
    ...
    public boolean contains(Set2Item value)
    {
        return items.contains(value);
    }

    public boolean containsAll(java.util.Collection<Set2Item> values)
    {
    ...
    {
        private static final long serialVersionUID = -2429295575322571698L;
