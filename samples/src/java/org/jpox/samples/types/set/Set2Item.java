 ...
 **/
public class Set2Item implements Comparable
{
    ...
    public Set2Item(String name, double value, int status)
    {
        this.name   = name;
        this.value  = value;
        this.status = status;
    ...
    public void setContainer(Set2 cont)
    {
        container = cont;
    }
    ...
    {
        return compareTo((Set2Item)o);
    }

    public int compareTo(Set2Item other)
    {
    ...
    {
        if (obj == null || !(obj instanceof Set2Item))
        {
            return false;
        }

        Set2Item item = (Set2Item)obj;
