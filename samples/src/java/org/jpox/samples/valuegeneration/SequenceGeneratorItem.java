...
/**
 * Test case for the "sequence" generator.
 *
 * @version $Revision: 1.1 $  
 */
public class SequenceGeneratorItem
{
    private int identifier; // Generated field

    protected String name=null;

    protected SequenceGeneratorItem()
    {
    }

    public SequenceGeneratorItem(String name)
    {
        this.name   = name;
    }
