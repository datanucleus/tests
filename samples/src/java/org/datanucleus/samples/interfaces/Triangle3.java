 ...
 **/
public class Triangle3 implements ShapeInverse
{
    private int id;
    ...
    public Triangle3(int id,String composed,double width,double length)
    {
        this.id = id;
    ...
    {
        private static final long serialVersionUID = 7206772326595702978L;
        public int id;
