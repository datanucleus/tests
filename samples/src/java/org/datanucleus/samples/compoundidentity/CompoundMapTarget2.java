 ...
 */
public class CompoundMapTarget2
{
    ...
    public CompoundMapTarget2(String name, CompoundHolder source, double value)
    {
        super();
        this.name = name;
        this.holder = source;
    ...
    {
        private static final long serialVersionUID = 205648058933567654L;
        public String name;
