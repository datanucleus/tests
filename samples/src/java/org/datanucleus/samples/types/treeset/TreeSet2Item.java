...
/**
 * An item to store in an FK TreeSet container.
 *
 * @version $Revision: 1.1 $  
 **/
public class TreeSet2Item implements Comparable
{
    ...
    protected TreeSet2 container;

    protected TreeSet2Item()
    {
    ...
    public TreeSet2Item(String name,
                              double value,
                              int status)
    {
        this.name   = name;
    ...
    public void setContainer(TreeSet2 cont)
    {
        container = cont;
    }
    ...
    {
        return compareTo((TreeSet2Item)o);
    }

    public int compareTo(TreeSet2Item other)
    {
    ...
    {
        if (obj == null || !(obj instanceof TreeSet2Item))
        {
            return false;
        }

        TreeSet2Item item = (TreeSet2Item)obj;
