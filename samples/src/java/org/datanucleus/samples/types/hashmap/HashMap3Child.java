...
/**
 * Container object for HashMap tests using primitive key/value in the Map.
 * This provides testing of an inherited container.
 *
 * @version $Revision: 1.1 $    
 **/
public class HashMap3Child extends HashMap3
{
    String name;

    public HashMap3Child()
    {
        super();
    }

    public HashMap3Child(String name)
    {
        super();
        this.name = name;
    }
