...
public class HashMap2Item
{
    ...
    protected HashMap2 container;
    protected String key;

    protected HashMap2Item()
    {
    ...
    public HashMap2Item(String name,
                           double value,
                           int status)
    {
        this.name   = name;
    ...
    {
        if( arg0 == null || !(arg0 instanceof HashMap2Item) )
        {
            return false;
        }
        HashMap2Item item = (HashMap2Item)arg0;
    ...
    public HashMap2 getContainer()
    {
        return container;
    }

    public void setContainer(HashMap2 container)
    {
