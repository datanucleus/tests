...
Contributions
    ...
***********************************************************************/
package org.datanucleus.samples.types.linkedlist;
...
/**
 * An item to store in an FK ArrayList container.
 *
 * @version $Revision: 1.1 $  
 **/
public class LinkedList2Item
{
    ...
    protected LinkedList2 container;

    protected LinkedList2Item()
    {
    ...
    public LinkedList2Item(String name, double value, int status)
    {
        this.name   = name;
        this.value  = value;
        this.status = status;
    ...
    public LinkedList2 getContainer()
    {
        return container;
    }

    public void setContainer(LinkedList2 container)
    {
    ...
    {
        private static final long serialVersionUID = 1280345311965185238L;
