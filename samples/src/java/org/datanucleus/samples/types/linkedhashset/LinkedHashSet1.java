...
/**
 * Container object for join LinkedHashSet tests.
 */
public class LinkedHashSet1 implements CollectionHolder<ContainerItem>
{
    ...
    java.util.LinkedHashSet<ContainerItem> items = new java.util.LinkedHashSet<>();
