...
/**
 * An item to store in an FK LinkedHashSet container.
 *
 * @version $Revision: 1.1 $  
 **/
public class LinkedHashSet2Item implements Comparable
{
    ...
    protected LinkedHashSet2 container;

    protected LinkedHashSet2Item()
    {
    ...
    public LinkedHashSet2Item(String name,
                              double value,
                              int status)
    {
        this.name   = name;
    ...
    public void setContainer(LinkedHashSet2 cont)
    {
        container = cont;
    }
    ...
    public LinkedHashSet2 getContainer()
    {
        return container;
    }
    ...
    {
        return compareTo((LinkedHashSet2Item)o);
    }

    public int compareTo(LinkedHashSet2Item other)
    {
    ...
    {
        if (obj == null || !(obj instanceof LinkedHashSet2Item))
        {
            return false;
        }

        LinkedHashSet2Item item = (LinkedHashSet2Item)obj;
