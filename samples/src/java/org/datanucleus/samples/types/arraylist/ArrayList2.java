 ...
 **/
public class ArrayList2 implements ListHolder<ArrayList2Item>
{
    ...
    java.util.ArrayList<ArrayList2Item> items=new java.util.ArrayList<>();
    ...
    public java.util.Collection<ArrayList2Item> getItems()
    {
        return items;
    }

    public ArrayList2Item getItem(int position)
    {
    ...
    public void addItem(ArrayList2Item item)
    {
        items.add(item);
    }

    public void addItems(java.util.Collection<ArrayList2Item> c)
    {
        items.addAll(c);
    }

    public void removeItem(ArrayList2Item item)
    {
        items.remove(item);
    }

    public void removeItems(java.util.Collection<ArrayList2Item> c)
    {
        items.removeAll(c);
    }

    public void retainItems(java.util.Collection<ArrayList2Item> c)
    {
        items.retainAll(c);
    }
    ...
    public void setItems(java.util.Collection<ArrayList2Item> items)
    {
        this.items.clear();
        this.items.addAll(items);
    }

    public boolean contains(ArrayList2Item value)
    {
        return items.contains(value);
    }

    public boolean containsAll(java.util.Collection<ArrayList2Item> values)
    {
        return items.containsAll(values);
    }

    public void addItem(ArrayList2Item item, int position)
    {
