...
public class ArrayList2Item
{
    ...
    protected ArrayList2 container;

    protected ArrayList2Item()
    {
    ...
    public ArrayList2Item(String name, double value, int status)
    {
        this.name   = name;
        this.value  = value;
        this.status = status;
    ...
    public ArrayList2 getContainer()
    {
        return container;
    }

    public void setContainer(ArrayList2 container)
    {
