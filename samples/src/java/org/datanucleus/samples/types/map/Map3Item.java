...
public class Map3Item
{
    ...
    protected Map3 container;
    protected ContainerItem key;
    ...
    public Map3Item(String name, double value, int status)
    {
        this.name   = name;
        this.value  = value;
        this.status = status;
    ...
    {
        if( arg0 == null || !(arg0 instanceof Map3Item) )
        {
            return false;
        }
        Map3Item item = (Map3Item)arg0;
    ...
    public Map3 getContainer()
    {
        return container;
    }

    public void setContainer(Map3 container)
    {
    ...
    public ContainerItem getKey()
    {
        return key;
    }

    public void setKey(ContainerItem key)
    {
        this.key = key;
    }
    ...
    {
        return name + " - value=" + value + " [status=" + status + "]";
    }
