...
/**
 * Holder of Decimal field types to use as a test for persisting basic information.
 *
 * @version $Revision: 1.1 $
 */
public class DecimalHolder extends TestObject
{
     ...
     * By comparing against an original copy of the object, <code>compareTo()</code> can be used to 
     * verify that the object has been written to a database and read back correctly.
     *
    ...
    public boolean compareTo(Object obj)
    {
        ...
        DecimalHolder w = (DecimalHolder)obj;
        if (bigIntegerField == null)
        { 
            if (w.bigIntegerField != null)
            {
                return false; 
            }
        }
        else if (!bigIntegerField.equals(w.bigIntegerField))
        {
            return false;
        }
        ...
        { 
            if (w.bigDecimalField != null) 
            {
                return false; 
            }
        }
        else if (bigDecimalField.compareTo(w.bigDecimalField) != 0) 
        {
            return false;
        }
