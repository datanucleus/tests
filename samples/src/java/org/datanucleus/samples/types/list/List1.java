...
/**
 * Container object for join List tests.
 */
public class List1 implements ListHolder<ContainerItem>
{
    ...
    java.util.List<ContainerItem> items = new java.util.ArrayList<>();
    ...
    {
        private static final long serialVersionUID = -3833453752904605225L;
