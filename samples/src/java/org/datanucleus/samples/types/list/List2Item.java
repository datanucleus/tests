...
Contributions
    ...
***********************************************************************/
package org.datanucleus.samples.types.list;
...
/**
 * An item to store in an FK List container.
 *
...
public class List2Item
{
    ...
    public List2Item(String name, double value, int status)
    {
        this.name   = name;
        this.value  = value;
        this.status = status;
    ...
    public List2 getContainer()
    {
        return container;
    }

    public void setContainer(List2 container)
    {
    ...
    {
        private static final long serialVersionUID = -1049919603308110777L;
